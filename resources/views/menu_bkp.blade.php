...
<head>
    ...
    <link type="text/css" rel="stylesheet" href={{ asset('/lib/materialize/dist/css/forms.css') }} media="screen,projection"/>
...
@section('content')
    ...
    <script type="text/javascript" src={{ asset('/lib/datatables/media/js/jquery.dataTables.js') }}></script>
        ...
        <script>
            angular.module("mbCredCBO", [], function ($interpolateProvider){
                $interpolateProvider.startSymbol('[[').endSymbol(']]');
            })
                    angular.module("mbCredCBO").controller("AgenteCrtl", function ($scope){
                        console.log('teste');
                    });
