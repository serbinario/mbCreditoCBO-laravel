...
namespace SerbinarioAcao\Http\Controllers;

use Illuminate\Http\Request;

use SerbinarioAcao\Http\Requests;
use SerbinarioAcao\Http\Controllers\Controller;
use SerbinarioAcao\Services\UserService;
use SerbinarioAcao\Validators\UserValidator;
